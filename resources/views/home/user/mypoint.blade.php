        ...
        <div class="m_right">
            ...
            <div class="center6">
                <div class="center-title" >
                    <span style="margin-left: 10px;"> 我的积分</span>

                </div>

                <div class="my-jifen" >
                    <div class="my-jifen1" style="border-right: 1px solid #dcdcdc;">
                        可用积分
                        <b class="red"> {{$userInfo['point']}}</b>个
                    </div>
                    <div class="my-jifen2">
                        2019-12-31 将过期积分
                        <b class="red"> 0</b>个
