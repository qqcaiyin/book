...
<div class="i_bg bg_color">
    ...
    <div class="m_content">
        ...
        <div class="m_right">
            ...
            <div class="center1">
                <div class="borb"  style="width: 100%;">
                    <div class= "lside" style="padding-top: 10px;width: 100%;">
                       <div><span style =" float:left;   margin-left: 20px; width: 30%;">售后服务</span> </div>
                        <div><a  style="color:#007cc3; float: right;  margin-right: 10px;" href="{{url('/myorder?t=6')}}">申请售后</a></div>
                    </div>
                </div>
                <!--评论订单列表 -start--->
                <div class="dingdan" style="margin-top: 0px;" >
                    <div class="dd-list">
                        <div class="dd-title">
                            <ul >
                                <li class="td1">退换货编号</li>
                                <li class="td1">订单号</li>
                                <li class="td3">商品名称</li>
                                <li class="td2">申请时间</li>
                                <li class="td4">状态</li>
                                <li class="td4">操作</li>
                            </ul>
                        </div>
                                        ...
                                        <div >
                                            ...
                                            <div  class= "price" style="text-align: center; "  >
                                                <div style=" float:left; margin-right: 0px; text-align: left;padding: 0 0 0 15px;">
                                                        <a   href="{{url('/product/'.$apply['product_id'])}}">{{$apply['product_name']}}[{{$apply['spec_value']}}] x{{$apply['product_num']}} </a>
                                                </div>
                                            </div>
                                            <div class="num"  >
                                                <p>{{date('Y-m-d H:i:s',$apply['apply_time'])}}</p>
                                            </div>
                                            <div class="total" >
                                                @if($apply['status'] == 0)
                                                    <span>待审核</span>
                                            ...
                                            <div class="more-pro" style="text-align: center; ">
                                               <a style=" color:#007cc3; " href="{{url('/servicedetails?sn='.$apply['return_sn'] )}}">查看</a>
                                            </div>
                                        </div>
                                    </li>
                                @endforeach
