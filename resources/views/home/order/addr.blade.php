...
<div class="i_bg">
    ...
    <div class="content mar_20">
        <div class="two_bg">
            ...
            <form method="post"  action="{{url('/home/order/addr_add')}}"   id="form-addr">
                {{csrf_field()}}
            ...
            <table border="0" class="peo_tab" style="width:1110px;" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    ...
                    <td colspan="3"><textarea   style=" width:800px;"  name="district" ></textarea></td>
                </tr>
            </table>
            <div style=" text-align: right; width:1110px; margin-top: 15px;">
                <a  id="sub" href="javascript:vold();"><img src="/home/images/btn_sure.gif" /></a>
            </div>
            </form>
        </div>
    ...
    $(function() {
        $(document).on('change',':input[name="region[]"]',function(){
            ...
            $.get(url,{ 'p':id},function(data){
                if(data.status ==0 ) {
                    //返回成功
                      var str = '<select name="region[]"  > <option value="0" selected>------</option>';
