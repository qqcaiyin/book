...
<div class="page-container">
    <form class="form form-horizontal"  action ="/product/images"  method="post"  id="form-images">
        {{csrf_field()}}
        <div class="row cl">
        ...
        <div class="row cl">
            <div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2">
                <button type="submit" class="btn btn-primary radius" type="button"><i class="Hui-iconfont">&#xe632;</i> 保存并提交审核</button>
...
//上传成功后，路径保存到隐藏域
               ...
               // var img ='<img src="'+url+'">';
               // $('#imagesload').append( img );
                var input ='<input name="images[]" type="hidden" value="'+url+'">';
